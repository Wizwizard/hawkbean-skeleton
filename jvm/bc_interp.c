...
handle_iushr (u1 * bc, java_class_t * cls) {
    ...
    res.int_val = ((a >= 0) ? (u4)((u4)a >> b) : (u4)(((u4)a >> b) + (2<<~b)));
    push_val(res);
	return 1;
}
...
int
hb_instr_repr (jthread_t * t, char * buf, size_t buflen)
{
