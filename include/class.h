...
static inline char **
hb_get_method_args (method_info_t * m) { return m->args; }

static inline char *
hb_get_method_name (method_info_t * m) { return m->name; }

static inline char * 
hb_get_method_return_type (method_info_t * m) { return m->ret_type; }
...
static inline int
hb_get_method_count (java_class_t * cls)
{
